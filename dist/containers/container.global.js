...
const transaction_services_1 = require("../services/transaction/transaction.services");
...
container.register('TransactionService', new transaction_services_1.TransactionService());
...
container.register('WalletController', new wallet_controller_1.default(container.resolve('WalletService'), container.resolve('TransactionService')));
container.register('TransactionController', new transaction_controller_1.default(container.resolve('TransactionService')));
